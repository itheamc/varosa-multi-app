...
import 'modules/common/features/auth/bloc/refresh_token_bloc.dart';
import 'modules/common/features/auth/repository/auth_repository.dart';
import 'modules/common/features/auth/repository/auth_repository_impl.dart';
      ...
      child: MultiRepositoryProvider(
        providers: [
          ...
          RepositoryProvider<AuthRepository>(
            create: (context) =>
                AuthRepositoryImpl(context.read<HttpService>()),
          ),
